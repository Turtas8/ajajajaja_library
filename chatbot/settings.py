...
# from simple_chatbot.settings import simple_chatbot_settings
...
chatbot_settings = SimpleChatbotSettings(None, DEFAULTS, MODULES)


def reload_chatbot_settings(*args, **kwargs):
    setting = kwargs['setting']
    if setting == 'SIMPLE_CHATBOT':
        chatbot_settings.reload()


setting_changed.connect(reload_chatbot_settings)